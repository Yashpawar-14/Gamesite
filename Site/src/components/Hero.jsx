...
const Hero = () => {
    ...
    const upcomingVideos = (currentIndex % totalVidoes) +1;
        ...
        <div id="video-frame" className='relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75'>
           ...
           <div className='absolute left-0 top-0 z-40 size-full '>
            <div className='mt-24 px-5 sm:px-10'>
                ...
                <p className='mb-5 max-w-64 font-robert-regular text-blue-100'>Enter the MetaGame Layer <br/>Unleash the Enconomy</p>
                <Button  id="watch-trailer" title="Watch Trailer" leftIcon={<TiLocationArrow />} conatinerClas="bg-yellow-300 flex-center gap-1"/>
            </div>
